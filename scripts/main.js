...
function initMap() {
  ...
  // call function to get the route when clicking button
  document.getElementById('berekenRoute').onclick = function(){ 
    calculateAndDisplayRoute(directionsService, directionsDisplay);
  };

  // verberg route
  document.getElementById('verbergRoute').onclick = function(){ 
    initMap();
  };
